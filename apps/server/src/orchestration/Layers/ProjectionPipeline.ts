      ...
      switch (event.type) {
        case "project.created":
          yield* projectionProjectRepository.upsert({
            ...
            allowedProviderInstances: event.payload.allowedProviderInstances ?? null,
        ...
        case "project.meta-updated": {
          ...
          yield* projectionProjectRepository.upsert({
            ...
            ...(event.payload.defaultModelSelection !== undefined
              ? { defaultModelSelection: event.payload.defaultModelSelection }
              : {}),
            ...(event.payload.allowedProviderInstances !== undefined
              ? { allowedProviderInstances: event.payload.allowedProviderInstances }
              : {}),
